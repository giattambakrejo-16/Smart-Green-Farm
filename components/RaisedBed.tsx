    ...
    <section className={`rounded-[30px] p-4 shadow-sm ring-1 sm:p-6 ${dark ? "bg-[#111827] ring-white/10" : "bg-white ring-slate-200"}`}>
      <div className="mb-5 flex items-start justify-between gap-3">
        <div className="flex gap-3">
          <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-teal-500/10 text-teal-400">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-4">
        ...
        <div className="col-span-2 sm:col-span-3 lg:col-span-4">
          <ManualControl title="Manual Control" dark={dark}>
            <ControlTile
              label="Pompa Air"
              active={raised.pump}
              icon={<Droplets size={22} />}
              dark={dark}
              onClick={() => setRaised({ ...raised, pump: !raised.pump })}
            />
