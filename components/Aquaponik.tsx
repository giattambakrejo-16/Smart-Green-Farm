...
import { ArrowDownCircle, Droplets, Fish, FlaskConical, Thermometer, Waves, Wind } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-4">
        ...
        <StatusCard dark={dark} label="Kondisi Air" value={aqua.ph >= 6.5 && aqua.ph <= 8 ? "Normal" : "Perlu Cek"} />
        ...
        <div className="col-span-2 sm:col-span-3 lg:col-span-4">
          <ManualControl title="Manual Control">
            <ControlTile
              label="Pompa Air"
              active={aqua.waterPump}
              icon={<Droplets size={22} />}
              onClick={() => setAqua({ ...aqua, waterPump: !aqua.waterPump })}
            />
            ...
            <ControlTile
              ...
              active={aqua.aerator}
              icon={<Wind size={22} />}
              onClick={() => setAqua({ ...aqua, aerator: !aqua.aerator })}
            />
            ...
            <ControlTile
              label="Drain Valve"
              active={aqua.drainValve}
              icon={<ArrowDownCircle size={22} />}
              onClick={() => setAqua({ ...aqua, drainValve: !aqua.drainValve })}
            />
          </ManualControl>
        </div>
      </div>
